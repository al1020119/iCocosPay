...
#define KWinXin @"iCocosPay"  // 回调ID


#define APP_ID          @"wx058a5abb7720ea82"               //微信APPID
#define APP_SECRET      @"d0b5b0c980fce630db44b9db52f78065" //微信appsecret
//商户号，填写商户对应参数（客户给）
#define MCH_ID          @"1253359601"
//商户API密钥，填写相应参数（客户给）
#define PARTNER_ID      @"b28be4b8a68f4ff8abdcacbb3bdc042d"
//支付结果回调页面（后台会给你）
#define NOTIFY_URL      @"http://wxpay.weixin.qq.com/pub_v2/pay/notify.v2.php" //@"http://wxpay.weixin.qq.com/pub_v2/pay/notify.v2.php"
//获取服务器端支付数据地址（商户自定义）
